...
[<img src="https://lthben.github.io/pizza.png">](https://github.com/lthben/FEND_website_optimisation/tree/master/dist/index.html)

Optimized an inefficient web application's JavaScript, CSS and assets delivery, ensuring it runs at 60fps and achieves a PageSpeed score of at least 90. Click on the browser back button when done.
...
Wrote comprehensive unit tests, using the Jasmine testing framework, for an RSS Feed Reader application that uses Google's RSS API. Click on the browser back button when done.
